...
/*
 * 2015-11-13移除bootstrap3-wysihtml5的文本编辑框 $.fn.wysihtml5 && (function() {
 * $('textarea.textarea').wysihtml5({ "size": "sm", "useLineBreaks": false,
 * "stylesheets": ["/plugins/bootstrap3-wysihtml5/wysihtml5-stylesheet.css"],
 * "toolbar": { "color": true, "blockquote": false, "fa": true, "html": true,
 * "paragraph": true }, "customTemplates": { paragraph: function(context) {
 * return '<li><div class="btn-group"><a class="btn btn-sm btn-default"
 * data-wysihtml5-command="formatInline" data-wysihtml5-command-value="p"
 * title="插入段落" tabindex="-1" href="javascript:;" unselectable="on"><span
 * class="fa fa-paragraph"></span></a></div></li>'; } } }); })();
 */
  ...
  $(".ueditorFlag").each(function() {
	  ...
	  var ue = UE.getEditor(id, {
  	  ...
  	  // 这里是在解决一个ueditor的bug(对我们来说是个bug), 每次编辑框获取焦点的时候都会自动插入<p><br/></p>
